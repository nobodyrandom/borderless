...
<div class="page-heading text-center">
    <div class="container zoomIn animated">
        <h1 class="page-title">NEWS <span class="title-under"></span></h1>
    </div>
</div>
    ...
    <div class="section-home our-sponsors animate-onscroll fadeIn">
        <div class="container">
            <div class="row fadeIn animated">
                <div class="col-md-6">
                    <h2 class="title-style-2"> Borderless News <span class="title-under"></span></h2>
                    <h3>
                        <a href="articles.php?article=1">02/02/16: SPOTLIGHT ON BURMESE MINORITIES: THE SHAN</a>
                    </h3>
                    <h3>
                        <a href="articles.php?article=2">01/26/16: SPOTLIGHT ON BURMESE MINORITIES: THE KAREN </a>
                    </h3>
                    <h3>
                        <a href="articles.php?article=3">11/24/15: BURMESE DAYS: MODERN MYANMAR/BURMA IN HISTORY</a>
                    </h3>
                </div>

                <div class="col-md-6">
                    <h2 class="title-style-2"> World News <span class="title-under"></span></h2>
                    <!-- start feedwind code -->
